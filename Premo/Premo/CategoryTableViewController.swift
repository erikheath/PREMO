...
class CategoryTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return (self.categoryObject?.contentItems?.count)! as Int ?? 0
    }
    ...
    func configureCell(cell: UITableViewCell, atIndexPath indexPath: NSIndexPath) {
        guard let object = self.categoryObject?.contentItems?[indexPath.row] as? ContentItem else { return }
        cell.textLabel!.text = object.contentSourceID
    }
    ...
    var fetchedResultsController: NSFetchedResultsController {
        ...
        let aFetchedResultsController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: self.managedObjectContext!, sectionNameKeyPath: nil, cacheName: "CategoryList")
